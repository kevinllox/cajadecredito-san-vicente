        ...
        <script>
            $(document).ready(function () {
                ...
                $('.enviarID').click(function (event) {
                    ...
                    var fecha = prompt("Por favor, ingrese la fecha (YYYY-MM-DD):");

                    // Verificar si se ingresó una fecha
                    if (fecha !== null) {
                        // Crear un formulario con el ID de finiquito y la fecha, y enviarlo mediante POST
                        var form = $('<form action="FiniquitoDesemGuardado" method="POST">' +
